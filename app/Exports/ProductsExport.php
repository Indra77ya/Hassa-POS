...
class ProductsExport implements FromArray
{
    ...
    {
        $business_id = session('user.business_id') ?? (auth()->check() ? auth()->user()->business_id : null);
