                ...
                <th>
                  ...
                  @php
                    $html = '<tr><td>
                        ...
                        <td>
                          <button class="btn btn-xs btn-danger pull-right remove-modifier-row" type="button"><i class="fa fa-minus"></i></button>
                        </td>
                        </tr>';
                  @endphp
                </th>
                ...
                <tr>
                  ...
                  <td>
                    @if(!$loop->first)
                      <button class="btn btn-xs btn-danger pull-right remove-modifier-row" type="button"><i class="fa fa-minus"></i></button>
                    @else
                      <button class="btn btn-xs btn-primary pull-right add-modifier-row" type="button" data-html="{{ $html }}">
