                    ...
                    <div class="sm:tw-flex sm:tw-items-center sm:tw-justify-between sm:tw-gap-12">
                            ...
                            @if (!auth()->user()->can('dashboard.data'))
                                <div class="tw-flex tw-items-center tw-gap-2 tw-mb-1.5">
                                    <span class="tw-inline-flex tw-items-center tw-gap-1.5 tw-text-xs tw-font-semibold tw-text-white/90 tw-bg-white/15 tw-px-2.5 tw-py-0.5 tw-rounded-full tw-backdrop-blur-sm tw-border tw-border-white/10">
                                        <span class="tw-w-1.5 tw-h-1.5 tw-rounded-full tw-bg-emerald-400"></span>
                                        {{ $time_greeting }}
                                    </span>
                        ...
                        @else
                            <div class="tw-mt-3 sm:tw-mt-0 tw-inline-flex tw-items-center tw-gap-2 tw-bg-white/10 tw-backdrop-blur-md tw-px-3.5 tw-py-2 tw-rounded-xl tw-text-white tw-text-sm tw-font-medium tw-border tw-border-white/10">
                                <i class="fa fa-calendar-alt text-white" style="font-size: 16px;"></i>
        ...
        <div class="tw-px-4 sm:tw-px-6 tw-py-6">
            <div class="tw-max-w-6xl tw-mx-auto">
                ...
                <div class="tw-mb-5 tw-flex tw-items-center tw-justify-between">
                    <div>
                        <h2 class="tw-text-lg sm:tw-text-xl tw-font-bold tw-text-gray-900 tw-flex tw-items-center tw-gap-2">
                            <span class="tw-inline-flex tw-items-center tw-justify-center tw-w-8 tw-h-8 tw-rounded-lg tw-bg-blue-600 tw-text-white tw-shadow-sm">
                ...
                <div class="tw-grid tw-grid-cols-1 sm:tw-grid-cols-2 lg:tw-grid-cols-3 tw-gap-4 md:tw-gap-5">
                    @if (auth()->user()->can('laundry.view') || auth()->user()->can('laundry.create') || auth()->user()->can('laundry.update_status') || auth()->user()->can('laundry.log_process'))
                        <div class="tw-group tw-bg-white tw-rounded-xl tw-p-4 md:tw-p-5 tw-border tw-border-gray-200 tw-shadow-sm hover:tw-shadow-md hover:tw-border-blue-400 tw-transition-all tw-duration-200 tw-flex tw-flex-col tw-justify-between">
                            <div>
                                <div class="tw-flex tw-items-center tw-justify-between tw-mb-3">
                                    <div class="tw-w-11 tw-h-11 tw-rounded-xl tw-bg-blue-100 tw-text-blue-600 tw-flex tw-items-center tw-justify-center group-hover:tw-scale-105 tw-transition-transform">
                                        <i class="fas fa-tshirt" style="font-size: 20px;"></i>
                                    </div>
                                    <span class="tw-text-xs tw-font-bold tw-text-blue-700 tw-bg-blue-50 tw-px-2.5 tw-py-0.5 tw-rounded-full">Laundry</span>
                                </div>
                                <h3 class="tw-text-base tw-font-bold tw-text-gray-900 group-hover:tw-text-blue-600 tw-transition-colors">Pesanan Laundry</h3>
                                <p class="tw-text-xs tw-text-gray-600 tw-mt-1 tw-leading-relaxed">Lihat, kelola, dan catat lembar pesanan laundry pelanggan dengan cepat.</p>
                            </div>
                            <div class="tw-mt-4 tw-pt-3 tw-border-t tw-border-gray-100 tw-flex tw-items-center tw-gap-2">
                                <a href="{{ action([\Modules\Laundry\Http\Controllers\OrderSheetController::class, 'index']) }}"
                                   class="tw-flex-1 tw-inline-flex tw-items-center tw-justify-center tw-gap-1.5 tw-px-3 tw-py-2 tw-rounded-lg tw-bg-blue-50 tw-text-blue-700 hover:tw-bg-blue-600 hover:tw-text-white tw-text-xs tw-font-bold tw-transition-colors">
                    ...
                    @if (auth()->user()->can('sell.create') || auth()->user()->can('pos.create'))
                        <div class="tw-group tw-bg-white tw-rounded-xl tw-p-4 md:tw-p-5 tw-border tw-border-gray-200 tw-shadow-sm hover:tw-shadow-md hover:tw-border-emerald-400 tw-transition-all tw-duration-200 tw-flex tw-flex-col tw-justify-between">
                            <div>
                                <div class="tw-flex tw-items-center tw-justify-between tw-mb-3">
                                    <div class="tw-w-11 tw-h-11 tw-rounded-xl tw-bg-emerald-100 tw-text-emerald-600 tw-flex tw-items-center tw-justify-center group-hover:tw-scale-105 tw-transition-transform">
                                        <i class="fa fa-shopping-cart" style="font-size: 20px;"></i>
                                    </div>
                                    <span class="tw-text-xs tw-font-bold tw-text-emerald-700 tw-bg-emerald-50 tw-px-2.5 tw-py-0.5 tw-rounded-full">POS</span>
                                </div>
                                ...
                                <p class="tw-text-xs tw-text-gray-600 tw-mt-1 tw-leading-relaxed">Buka terminal kasir penjualan untuk melayani pembayaran transaksi secara langsung.</p>
                            </div>
                            <div class="tw-mt-4 tw-pt-3 tw-border-t tw-border-gray-100 tw-flex tw-items-center tw-gap-2">
                                <a href="{{ action([\App\Http\Controllers\SellPosController::class, 'create']) }}"
                                   class="tw-flex-1 tw-inline-flex tw-items-center tw-justify-center tw-gap-1.5 tw-px-3 tw-py-2 tw-rounded-lg tw-bg-emerald-50 tw-text-emerald-700 hover:tw-bg-emerald-600 hover:tw-text-white tw-text-xs tw-font-bold tw-transition-colors">
                    ...
                    @if (auth()->user()->can('repair.view') || auth()->user()->can('job_sheet.create'))
                        <div class="tw-group tw-bg-white tw-rounded-xl tw-p-4 md:tw-p-5 tw-border tw-border-gray-200 tw-shadow-sm hover:tw-shadow-md hover:tw-border-amber-400 tw-transition-all tw-duration-200 tw-flex tw-flex-col tw-justify-between">
                            <div>
                                <div class="tw-flex tw-items-center tw-justify-between tw-mb-3">
                                    <div class="tw-w-11 tw-h-11 tw-rounded-xl tw-bg-amber-100 tw-text-amber-600 tw-flex tw-items-center tw-justify-center group-hover:tw-scale-105 tw-transition-transform">
                                        <i class="fa fa-wrench" style="font-size: 20px;"></i>
                                    </div>
                                    <span class="tw-text-xs tw-font-bold tw-text-amber-700 tw-bg-amber-50 tw-px-2.5 tw-py-0.5 tw-rounded-full">Servis</span>
                                </div>
                                <h3 class="tw-text-base tw-font-bold tw-text-gray-900 group-hover:tw-text-amber-600 tw-transition-colors">Servis & Repair</h3>
                                <p class="tw-text-xs tw-text-gray-600 tw-mt-1 tw-leading-relaxed">Kelola job sheet penerimaan dan status pengerjaan servis barang.</p>
                            </div>
                            <div class="tw-mt-4 tw-pt-3 tw-border-t tw-border-gray-100 tw-flex tw-items-center tw-gap-2">
                                <a href="{{ action([\Modules\Repair\Http\Controllers\JobSheetController::class, 'index']) }}"
                                   class="tw-flex-1 tw-inline-flex tw-items-center tw-justify-center tw-gap-1.5 tw-px-3 tw-py-2 tw-rounded-lg tw-bg-amber-50 tw-text-amber-700 hover:tw-bg-amber-600 hover:tw-text-white tw-text-xs tw-font-bold tw-transition-colors">
                    ...
                    @if (auth()->user()->can('product.view') || auth()->user()->can('product.create'))
                        <div class="tw-group tw-bg-white tw-rounded-xl tw-p-4 md:tw-p-5 tw-border tw-border-gray-200 tw-shadow-sm hover:tw-shadow-md hover:tw-border-purple-400 tw-transition-all tw-duration-200 tw-flex tw-flex-col tw-justify-between">
                            <div>
                                <div class="tw-flex tw-items-center tw-justify-between tw-mb-3">
                                    <div class="tw-w-11 tw-h-11 tw-rounded-xl tw-bg-purple-100 tw-text-purple-600 tw-flex tw-items-center tw-justify-center group-hover:tw-scale-105 tw-transition-transform">
                                        <i class="fa fa-cubes" style="font-size: 20px;"></i>
                                    </div>
                                    <span class="tw-text-xs tw-font-bold tw-text-purple-700 tw-bg-purple-50 tw-px-2.5 tw-py-0.5 tw-rounded-full">Produk</span>
                                </div>
                                <h3 class="tw-text-base tw-font-bold tw-text-gray-900 group-hover:tw-text-purple-600 tw-transition-colors">Daftar Produk</h3>
                                <p class="tw-text-xs tw-text-gray-600 tw-mt-1 tw-leading-relaxed">Lihat & periksa katalog barang, harga variasi, serta posisi stok terkini.</p>
                            </div>
                            <div class="tw-mt-4 tw-pt-3 tw-border-t tw-border-gray-100 tw-flex tw-items-center tw-gap-2">
                                <a href="{{ action([\App\Http\Controllers\ProductController::class, 'index']) }}"
                                   class="tw-flex-1 tw-inline-flex tw-items-center tw-justify-center tw-gap-1.5 tw-px-3 tw-py-2 tw-rounded-lg tw-bg-purple-50 tw-text-purple-700 hover:tw-bg-purple-600 hover:tw-text-white tw-text-xs tw-font-bold tw-transition-colors">
                    ...
                    @if (auth()->user()->can('customer.view') || auth()->user()->can('customer.create'))
                        <div class="tw-group tw-bg-white tw-rounded-xl tw-p-4 md:tw-p-5 tw-border tw-border-gray-200 tw-shadow-sm hover:tw-shadow-md hover:tw-border-indigo-400 tw-transition-all tw-duration-200 tw-flex tw-flex-col tw-justify-between">
                            <div>
                                <div class="tw-flex tw-items-center tw-justify-between tw-mb-3">
                                    <div class="tw-w-11 tw-h-11 tw-rounded-xl tw-bg-indigo-100 tw-text-indigo-600 tw-flex tw-items-center tw-justify-center group-hover:tw-scale-105 tw-transition-transform">
                                        <i class="fa fa-users" style="font-size: 20px;"></i>
                                    </div>
                                    <span class="tw-text-xs tw-font-bold tw-text-indigo-700 tw-bg-indigo-50 tw-px-2.5 tw-py-0.5 tw-rounded-full">Kontak</span>
                                </div>
                                ...
                                <p class="tw-text-xs tw-text-gray-600 tw-mt-1 tw-leading-relaxed">Kelola informasi data pelanggan, nomor kontak, dan riwayat transaksi.</p>
                            </div>
                            <div class="tw-mt-4 tw-pt-3 tw-border-t tw-border-gray-100 tw-flex tw-items-center tw-gap-2">
                                <a href="{{ action([\App\Http\Controllers\ContactController::class, 'index'], ['type' => 'customer']) }}"
                                   class="tw-flex-1 tw-inline-flex tw-items-center tw-justify-center tw-gap-1.5 tw-px-3 tw-py-2 tw-rounded-lg tw-bg-indigo-50 tw-text-indigo-700 hover:tw-bg-indigo-600 hover:tw-text-white tw-text-xs tw-font-bold tw-transition-colors">
                    ...
                    @if (auth()->user()->can('sell.view') || auth()->user()->can('direct_sell.view'))
                        <div class="tw-group tw-bg-white tw-rounded-xl tw-p-4 md:tw-p-5 tw-border tw-border-gray-200 tw-shadow-sm hover:tw-shadow-md hover:tw-border-teal-400 tw-transition-all tw-duration-200 tw-flex tw-flex-col tw-justify-between">
                            <div>
                                <div class="tw-flex tw-items-center tw-justify-between tw-mb-3">
                                    <div class="tw-w-11 tw-h-11 tw-rounded-xl tw-bg-teal-100 tw-text-teal-600 tw-flex tw-items-center tw-justify-center group-hover:tw-scale-105 tw-transition-transform">
                                        <i class="fa fa-file-invoice" style="font-size: 20px;"></i>
                                    </div>
                                    <span class="tw-text-xs tw-font-bold tw-text-teal-700 tw-bg-teal-50 tw-px-2.5 tw-py-0.5 tw-rounded-full">Penjualan</span>
                                </div>
                                ...
                                <p class="tw-text-xs tw-text-gray-600 tw-mt-1 tw-leading-relaxed">Lihat, periksa, dan cetak riwayat faktur transaksi penjualan toko.</p>
                            </div>
                            <div class="tw-mt-4 tw-pt-3 tw-border-t tw-border-gray-100 tw-flex tw-items-center tw-gap-2">
                                <a href="{{ action([\App\Http\Controllers\SellController::class, 'index']) }}"
                                   class="tw-flex-1 tw-inline-flex tw-items-center tw-justify-center tw-gap-1.5 tw-px-3 tw-py-2 tw-rounded-lg tw-bg-teal-50 tw-text-teal-700 hover:tw-bg-teal-600 hover:tw-text-white tw-text-xs tw-font-bold tw-transition-colors">
                    ...
                    @if (auth()->user()->can('purchase.view') || auth()->user()->can('purchase.create'))
                        <div class="tw-group tw-bg-white tw-rounded-xl tw-p-4 md:tw-p-5 tw-border tw-border-gray-200 tw-shadow-sm hover:tw-shadow-md hover:tw-border-sky-400 tw-transition-all tw-duration-200 tw-flex tw-flex-col tw-justify-between">
                            <div>
                                <div class="tw-flex tw-items-center tw-justify-between tw-mb-3">
                                    <div class="tw-w-11 tw-h-11 tw-rounded-xl tw-bg-sky-100 tw-text-sky-600 tw-flex tw-items-center tw-justify-center group-hover:tw-scale-105 tw-transition-transform">
                                        <i class="fa fa-truck" style="font-size: 20px;"></i>
                                    </div>
                                    <span class="tw-text-xs tw-font-bold tw-text-sky-700 tw-bg-sky-50 tw-px-2.5 tw-py-0.5 tw-rounded-full">Pembelian</span>
                                </div>
                                <h3 class="tw-text-base tw-font-bold tw-text-gray-900 group-hover:tw-text-sky-600 tw-transition-colors">Pembelian Stok</h3>
                                <p class="tw-text-xs tw-text-gray-600 tw-mt-1 tw-leading-relaxed">Catat transaksi pembelian stok barang dari pemasok / supplier.</p>
                            </div>
                            <div class="tw-mt-4 tw-pt-3 tw-border-t tw-border-gray-100 tw-flex tw-items-center tw-gap-2">
                                <a href="{{ action([\App\Http\Controllers\PurchaseController::class, 'index']) }}"
                                   class="tw-flex-1 tw-inline-flex tw-items-center tw-justify-center tw-gap-1.5 tw-px-3 tw-py-2 tw-rounded-lg tw-bg-sky-50 tw-text-sky-700 hover:tw-bg-sky-600 hover:tw-text-white tw-text-xs tw-font-bold tw-transition-colors">
                    ...
                    @if (auth()->user()->can('expense.access') || auth()->user()->can('expense.add'))
                        <div class="tw-group tw-bg-white tw-rounded-xl tw-p-4 md:tw-p-5 tw-border tw-border-gray-200 tw-shadow-sm hover:tw-shadow-md hover:tw-border-rose-400 tw-transition-all tw-duration-200 tw-flex tw-flex-col tw-justify-between">
                            <div>
                                <div class="tw-flex tw-items-center tw-justify-between tw-mb-3">
                                    <div class="tw-w-11 tw-h-11 tw-rounded-xl tw-bg-rose-100 tw-text-rose-600 tw-flex tw-items-center tw-justify-center group-hover:tw-scale-105 tw-transition-transform">
                                        <i class="fa fa-receipt" style="font-size: 20px;"></i>
                                    </div>
                                    <span class="tw-text-xs tw-font-bold tw-text-rose-700 tw-bg-rose-50 tw-px-2.5 tw-py-0.5 tw-rounded-full">Pengeluaran</span>
                                </div>
                                ...
                                <p class="tw-text-xs tw-text-gray-600 tw-mt-1 tw-leading-relaxed">Catat dan pantau pengeluaran biaya operasional harian usaha.</p>
                            </div>
                            <div class="tw-mt-4 tw-pt-3 tw-border-t tw-border-gray-100 tw-flex tw-items-center tw-gap-2">
                                <a href="{{ action([\App\Http\Controllers\ExpenseController::class, 'index']) }}"
                                   class="tw-flex-1 tw-inline-flex tw-items-center tw-justify-center tw-gap-1.5 tw-px-3 tw-py-2 tw-rounded-lg tw-bg-rose-50 tw-text-rose-700 hover:tw-bg-rose-600 hover:tw-text-white tw-text-xs tw-font-bold tw-transition-colors">
                    ...
                    @if (auth()->user()->can('stock_adjustment.view') || auth()->user()->can('stock_adjustment.create'))
                        <div class="tw-group tw-bg-white tw-rounded-xl tw-p-4 md:tw-p-5 tw-border tw-border-gray-200 tw-shadow-sm hover:tw-shadow-md hover:tw-border-orange-400 tw-transition-all tw-duration-200 tw-flex tw-flex-col tw-justify-between">
                            <div>
                                <div class="tw-flex tw-items-center tw-justify-between tw-mb-3">
                                    <div class="tw-w-11 tw-h-11 tw-rounded-xl tw-bg-orange-100 tw-text-orange-600 tw-flex tw-items-center tw-justify-center group-hover:tw-scale-105 tw-transition-transform">
                                        <i class="fa fa-sliders-h" style="font-size: 20px;"></i>
                                    </div>
                                    <span class="tw-text-xs tw-font-bold tw-text-orange-700 tw-bg-orange-50 tw-px-2.5 tw-py-0.5 tw-rounded-full">Stok</span>
                                </div>
                                ...
                                <p class="tw-text-xs tw-text-gray-600 tw-mt-1 tw-leading-relaxed">Sesuaikan fisik stok barang rusak, hilang, atau opname inventaris.</p>
                            </div>
                            <div class="tw-mt-4 tw-pt-3 tw-border-t tw-border-gray-100 tw-flex tw-items-center tw-gap-2">
                                <a href="{{ action([\App\Http\Controllers\StockAdjustmentController::class, 'index']) }}"
                                   class="tw-flex-1 tw-inline-flex tw-items-center tw-justify-center tw-gap-1.5 tw-px-3 tw-py-2 tw-rounded-lg tw-bg-orange-50 tw-text-orange-700 hover:tw-bg-orange-600 hover:tw-text-white tw-text-xs tw-font-bold tw-transition-colors">
