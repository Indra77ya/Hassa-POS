...
<section class="content">
    ...
    @component('components.widget', ['class' => 'box-primary'])
        {!! Form::open(['url' => action([\App\Http\Controllers\RoleController::class, 'update'], [$role->id]), 'method' => 'PUT', 'id' => 'role_edit_form' ]) !!}
              ...
              <div class="row">
                <div class="col-md-4 col-sm-6 col-xs-12">
                  <div class="checkbox">
                    <label style="font-weight: 500;">
                      {!! Form::checkbox('permissions[]', 'access_default_selling_price', in_array('access_default_selling_price', $role_permissions), ['class' => 'input-icheck']); !!}
                ...
                @foreach($selling_price_groups as $selling_price_group)
                  <div class="col-md-4 col-sm-6 col-xs-12">
                    <div class="checkbox">
                      <label style="font-weight: 500;">
                        {!! Form::checkbox('spg_permissions[]', 'selling_price_group.' . $selling_price_group->id, in_array('selling_price_group.' . $selling_price_group->id, $role_permissions), ['class' => 'input-icheck']); !!}
        ...
        <div class="row" style="margin-top: 30px;">
          <div class="col-md-12 text-center">
             <button type="submit" class="btn btn-primary btn-lg" style="padding: 10px 40px; font-weight: 600;">@lang( 'messages.update' )</button>
          </div>
        </div>
