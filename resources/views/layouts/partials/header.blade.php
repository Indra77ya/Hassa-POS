...
<div
    class="  tw-transition-all tw-duration-5000 tw-border-b tw-bg-@if(!empty(session('business.theme_color'))){{session('business.theme_color')}}@else{{'primary'}}@endif-800 tw-shrink-0 lg:tw-h-15 tw-border-primary-500/30 no-print" style="border-bottom-width: 0px;">
