...
<li class="dropdown notifications-menu tw-list-none">
    ...
    <a type="button"
        class="btn dropdown-toggle load_notifications tw-inline-flex tw-items-center tw-ring-1 tw-ring-white/10 tw-justify-center tw-text-sm tw-font-medium hover:tw-text-white tw-p-1.5 tw-rounded-lg btn-primary"
