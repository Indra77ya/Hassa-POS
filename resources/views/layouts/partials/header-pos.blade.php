    ...
    <div
        ...
        <div class="tw-w-full md:tw-w-2/3 !tw-p-0 tw-flex tw-items-center tw-justify-end tw-gap-2.5 tw-flex-wrap md:tw-flex-nowrap tw-hidden md:tw-flex"
            ...
            <button type="button" id="toggle-dark-mode" title="Toggle Dark Mode"
                ...
                <svg id="dark-mode-icon-sun" class="tw-size-4 tw-hidden" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
                    <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
