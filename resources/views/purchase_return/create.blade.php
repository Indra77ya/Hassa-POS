...
<br>
    <h1 class="tw-text-xl md:tw-text-3xl tw-font-bold tw-text-black">@lang('lang_v1.add_purchase_return')</h1>
</section>
...
<section class="content no-print">
	...
	<div class="row">
		<div class="col-md-12 text-center">
			<button type="button" id="submit_purchase_return_form" class="btn btn-primary btn-lg">@lang('messages.submit')</button>
		</div>
	</div>
	{!! Form::close() !!}
</section>
