...
<section class="content-header">
    <h1 class="tw-text-xl md:tw-text-3xl tw-text-black">@lang('lang_v1.add_purchase_requisition')</h1>
</section>
	...
	@component('components.widget', ['class' => 'box-solid'])
		...
		<div class="row">
			<div class="col-sm-12 text-right">
				<br>
				<button type="button" class="btn btn-warning btn-sm" id="show_pr_products"><i class="fas fa-search"></i> @lang('lang_v1.show_products')</button>
			</div>
		</div>
	@endcomponent
