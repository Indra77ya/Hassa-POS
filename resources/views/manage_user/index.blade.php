...
<section class="content-header">
    <h1 class="tw-text-xl md:tw-text-3xl tw-text-black">@lang( 'user.users' )
...
<section class="content">
    @component('components.widget', ['class' => 'box-primary', 'title' => __( 'user.all_users' )])
        @can('user.create')
            @slot('tool')
                <div class="box-tools">
                    <a class="btn btn-primary btn-sm pull-right" href="{{action([\App\Http\Controllers\ManageUserController::class, 'create'])}}">
