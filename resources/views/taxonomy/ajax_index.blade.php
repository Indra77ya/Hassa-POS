...
@endphp
@can('category.create')
	<button type="button" class="btn btn-primary btn-sm pull-right btn-modal" data-href="{{action([\App\Http\Controllers\TaxonomyController::class, 'create'])}}?type={{$category_type}}" data-container=".category_modal">
