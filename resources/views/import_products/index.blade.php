...
<section class="content-header">
    <h1 class="tw-text-xl md:tw-text-3xl tw-text-black">@lang('product.import_products')
    </h1>
</section>
    ...
    <div class="row">
        <div class="col-sm-12">
            @component('components.widget', ['class' => 'box-primary'])
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <a href="{{ url('files/import_products_csv_template.csv') }}" class="btn btn-success" download><i class="fa fa-download"></i> @lang('lang_v1.download_template_file') (CSV)</a>
                        &nbsp;
                        <a href="{{ url('files/import_products_csv_template.xls') }}" class="btn btn-success" download><i class="fa fa-download"></i> @lang('lang_v1.download_template_file') (Excel)</a>
                    </div>
                </div>
            @endcomponent
        </div>
