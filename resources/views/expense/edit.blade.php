      ...
      <div class="row">
        ...
        <div class="col-sm-4">
          <div class="form-group">
            ...
            {!! Form::select('expense_category_id', $expense_categories, $expense->expense_category_id, ['class' => 'form-control select2', 'placeholder' => __('messages.please_select')], $category_attributes ?? []); !!}
