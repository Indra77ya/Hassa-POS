<div class="row">
	<div class="col-md-12">
		<p class="tw-text-xs tw-text-indigo-600 tw-bg-indigo-50 tw-inline-block tw-py-1 tw-px-3 tw-rounded-full tw-mb-3"><strong>@lang('sale.invoice_no'):</strong> {{$transaction->invoice_no}}</p>
	</div>
	<div class="col-md-4">
		<div class="form-group tw-mb-3" style="width: 100% !important">
			...
			<small class="text-danger @if(empty($customer_due)) hide @endif contact_due_text tw-text-[11px] tw-mt-1 tw-block"><strong>@lang('account.customer_due'):</strong> <span>{{$customer_due ?? ''}}</span></small>
		</div>
	</div>
	<div class="col-md-8">
