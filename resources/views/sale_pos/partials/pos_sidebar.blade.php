...
<div class="row">
    ...
    @if(!empty($featured_products) && count($featured_products) > 0)
        <div class="col-md-12 text-right margin-bottom-10" id="feature_product_div">
            <button type="button" class="btn btn-warning btn-flat btn-xs" id="show_featured_products">
...
<div class="row">
    ...
    <div class="col-md-12">
        <div id="product_list_body" class="eq-height-row" style="max-height: 500px; overflow-y: auto;">
            <div id="product_list_items" class="col-md-12"></div>
        </div>
    </div>
