...
return [
    ...
    'product_prices_imported_successfully' => 'Products imported successfully',
    ...
    'update_product_price' => 'Update Product',
    ...
    'import_export_product_price' => 'Import Export Product',
    'instructions' => 'Instructions',
    'price_import_instruction_1' => 'Export products by clicking on above button',
    'price_import_instruction_2' => 'Make changes in product details including category, sub category, brand, tax, locations, prices & selling price groups.',
    'price_import_instruction_3' => 'Do not change any sku & headers',
    'price_import_instruction_4' => 'After making changes import the file',
    'export_product_prices' => 'Export products',
    ...
    "regenerate_help" => "<br/>1. Regenerate/publish modules css/js to fix not found issue. <br/> 2. Publish api module oauth files",
    "manage_modules" => "Manage Modules",
    "only_superadmin_can_access_manage_modules" => "Only superadmin can access manage modules",
    "buy" => "Buy",
    ...
    'view_all_purchase_n_stock_adjustment' => 'View all Purchase & Stock Adjustments',
    'total_quantity' => 'Total Quantity',
    'view_own_purchase_n_stock_adjustment' => 'View own Purchase & Stock Adjustments',
];