...
<?php $__env->startSection('content'); ?>
    ...
    <section class="content-header">
        <h1 class="tw-text-xl md:tw-text-3xl tw-font-bold tw-text-black"><?php echo app('translator')->get('superadmin::lang.communicator'); ?></h1>
    </section>
                            ...
                            <div
                                ...
                                <div class="">
                                    ...
                                    <div class="col-md-12 form-group">
                                        <?php echo Form::label('recipients', __('superadmin::lang.recipients') . ':*'); ?> <button type="button"
                                            class="tw-dw-btn tw-dw-btn-xs tw-dw-btn-outline  tw-dw-btn-primary select-all"><?php echo app('translator')->get('lang_v1.select_all'); ?></button> <button
                                            type="button"
                                            class="tw-dw-btn tw-dw-btn-xs tw-dw-btn-outline  tw-dw-btn-primary deselect-all"><?php echo app('translator')->get('lang_v1.deselect_all'); ?></button>
                                        <?php echo Form::select('recipients[]', $businesses, null, [
                                    ...
                                    <div class="col-md-12 form-group">
                                        <button type="submit" class="tw-dw-btn tw-dw-btn-error tw-text-white pull-right"
                                            id="send_message"><?php echo app('translator')->get('superadmin::lang.send'); ?></button>
                                    </div>
                                    <?php echo Form::close(); ?>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#message-history').DataTable({
                ...
                serverSide: true,
                fixedHeader:false,
                ajax: '<?php echo e(action([\Modules\Superadmin\Http\Controllers\CommunicatorController::class, 'getHistory']), false); ?>'
            });
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Hassa POS\Modules\Superadmin\Providers/../Resources/views/communicator/index.blade.php ENDPATH**/ ?>