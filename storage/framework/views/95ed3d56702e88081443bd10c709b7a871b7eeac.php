...
<div id="calculator" tabindex="-1"
  ...
  <div class="tw-flex tw-items-center tw-justify-between tw-bg-slate-50 tw-border-b tw-border-slate-200 tw--mx-2 tw--mt-2 tw-mb-2 tw-px-2.5 tw-py-1.5">
    <span class="tw-text-[10px] tw-font-bold tw-tracking-[.12em] tw-uppercase tw-text-slate-500"><?php echo app('translator')->get('lang_v1.calculator'); ?></span>
...
<?php /**PATH C:\laragon\www\Hassa POS\resources\views/layouts/partials/calculator.blade.php ENDPATH**/ ?>