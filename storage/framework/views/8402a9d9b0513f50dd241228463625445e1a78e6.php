...
<div class="pos-tab-content">
    <div class="row">
        <div class="col-xs-3">
            <div class="form-group">
                ...
                <?php echo Form::select('sms_settings[sms_service]', ['nexmo' => 'Nexmo', 'twilio' => 'Twilio', 'other' => __('lang_v1.other')], $sms_service , ['class' => 'form-control', 'id' => 'sms_service']); ?>
    ...
    <div class="row sms_service_settings <?php if($sms_service != 'other'): ?> hide <?php endif; ?>" data-service="other">
        ...
        <div class="col-xs-4">
            <div class="form-group">
                ...
                <div class="input-group">
                    <?php echo Form::text('sms_settings[send_to_param_name]', !empty($sms_settings['send_to_param_name']) ? $sms_settings['send_to_param_name'] : null, ['class' => 'form-control', 'id' => 'send_to_param_name']); ?>

                    <div class="input-group-addon">
                        <select class="" name="sms_settings[send_to_param_type]">
                            <option value="string" <?php if(empty($sms_settings['send_to_param_type']) || $sms_settings['send_to_param_type'] == 'string'): ?> selected <?php endif; ?>><?php echo e(__('lang_v1.string_default'), false); ?></option>
                            <option value="array" <?php if(!empty($sms_settings['send_to_param_type']) && $sms_settings['send_to_param_type'] == 'array'): ?> selected <?php endif; ?>><?php echo e(__('lang_v1.array'), false); ?></option>
                        </select>
                    </div>
                </div>
            </div>
        ...
        <div class="col-xs-3">
            <div class="form-group">
                <?php echo Form::label('data_parameter_type', __('lang_v1.data_parameter_type') . ':'); ?>

                <?php echo Form::select('sms_settings[data_parameter_type]', ['form-data' => 'Form Data', 'json' => 'JSON'], !empty($sms_settings['data_parameter_type']) ? $sms_settings['data_parameter_type'] : 'form-data', ['class' => 'form-control', 'id' => 'data_parameter_type']); ?>
...
</div><?php /**PATH C:\laragon\www\Hassa POS\resources\views/business/partials/settings_sms.blade.php ENDPATH**/ ?>