                ...
                <div class="input-group">
                    <span class="input-group-addon">
                        <select class="form-control input-sm" id="default_profit_margin_type" name="default_profit_margin_type" style="padding: 2px 5px; height: 28px; width: 70px;">
                            <option value="percentage" <?php if($business->default_profit_margin_type == 'percentage'): ?> selected <?php endif; ?>>%</option>
                            <option value="fixed" <?php if($business->default_profit_margin_type == 'fixed'): ?> selected <?php endif; ?>>Rp</option>
                        </select>
                    </span>
...
</div><?php /**PATH C:\laragon\www\Hassa POS\resources\views/business/partials/settings_business.blade.php ENDPATH**/ ?>