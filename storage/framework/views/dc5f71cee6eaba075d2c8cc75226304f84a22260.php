...
<div class="modal-dialog" role="document">
    <div class="modal-content edit-subscription-modal">
     <?php echo Form::open(['url' => action([\Modules\Superadmin\Http\Controllers\SuperadminSubscriptionsController::class, 'updateSubscription']), 'method' => 'POST', 'id' => 'edit_subscription_form']); ?>

      <?php echo Form::hidden('subscription_id', $subscription->id); ?>

      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="myModalLabel"><?php echo app('translator')->get( "superadmin::lang.edit_subscription"); ?></h4>
      </div>
      ...
      <div class="modal-footer">
        <button type="submit" class="tw-dw-btn tw-dw-btn-primary tw-text-white"><?php echo app('translator')->get( "superadmin::lang.update"); ?></button>
        <button type="button" class="tw-dw-btn tw-dw-btn-neutral tw-text-white" data-dismiss="modal"><?php echo app('translator')->get( "superadmin::lang.close"); ?></button>
      </div>
      <?php echo Form::close(); ?>

    </div>
</div>
<?php /**PATH C:\laragon\www\Hassa POS\Modules\Superadmin\Providers/../Resources/views/superadmin_subscription/edit_date_modal.blade.php ENDPATH**/ ?>