...
<?php $__env->startSection('content'); ?>
    ...
    <section class="content-header">
        <h1 class="tw-text-xl md:tw-text-3xl tw-font-bold tw-text-black"><?php echo app('translator')->get('sale.products'); ?>
            <small class="tw-text-sm md:tw-text-base tw-text-gray-700 tw-font-semibold"><?php echo app('translator')->get('lang_v1.manage_products'); ?></small>
        </h1>
        <!-- <ol class="breadcrumb">
                    ...
                    <?php if($is_woocommerce): ?>
                        <div class="col-md-3">
                            <div class="form-group">
                                <br>
                                <label>
                                    <?php echo Form::checkbox('woocommerce_enabled', 1, false, ['class' => 'input-icheck', 'id' => 'woocommerce_enabled']); ?> <?php echo e(__('lang_v1.woocommerce_enabled'), false); ?>
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('stock_report.view')): ?>
                                <li>
                                    <a href="#product_stock_report" class="product_stock_report" data-toggle="tab"
                                     ...
                                     <?php echo app('translator')->get('report.stock_report'); ?></a>
                                </li>
                            <?php endif; ?>
                        </ul>
                            ...
                            <div class="tab-pane active " id="product_list_tab">
                                <?php if($is_admin): ?>
                                    ...
                                    <a class="tw-dw-btn tw-bg-gradient-to-r tw-from-indigo-600 tw-to-blue-500 tw-font-bold tw-text-white tw-border-none tw-rounded-full pull-right tw-m-2"
                                        href="<?php echo e(action([\App\Http\Controllers\ProductController::class, 'downloadExcel']), false); ?>">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            ...
                                            <path d="M12 4l0 12" />
                                        </svg> <?php echo app('translator')->get('lang_v1.download_excel'); ?>
                                    </a>
                                <?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Hassa POS\resources\views/product/index.blade.php ENDPATH**/ ?>