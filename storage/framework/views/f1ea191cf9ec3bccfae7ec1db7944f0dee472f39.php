            ...
            <div class="col-md-12 col-xs-12">
                <div class="btn-group pull-right" data-toggle="buttons">
                    <label class="btn btn-info active">
                        <input type="radio" name="date-filter" data-start="<?php echo e(date('Y-m-d'), false); ?>"
                            data-end="<?php echo e(date('Y-m-d'), false); ?>" checked> <?php echo e(__('home.today'), false); ?>

                    </label>
                    <label class="btn btn-info">
                        <input type="radio" name="date-filter" data-start="<?php echo e($date_filters['this_week']['start'], false); ?>"
                            data-end="<?php echo e($date_filters['this_week']['end'], false); ?>"> <?php echo e(__('home.this_week'), false); ?>

                    </label>
                    <label class="btn btn-info">
                        <input type="radio" name="date-filter" data-start="<?php echo e($date_filters['this_month']['start'], false); ?>"
                            data-end="<?php echo e($date_filters['this_month']['end'], false); ?>"> <?php echo e(__('home.this_month'), false); ?>

                    </label>
                    <label class="btn btn-info">
                        <input type="radio" name="date-filter" data-start="<?php echo e($date_filters['this_yr']['start'], false); ?>"
                            data-end="<?php echo e($date_filters['this_yr']['end'], false); ?>"> <?php echo e(__('superadmin::lang.this_year'), false); ?>
            ...
            <div class="col-lg-4 col-xs-6">
                <?php $__env->startComponent('components.static', [
                    ...
                    <p class="tw-text-sm tw-font-medium tw-text-gray-500 tw-truncate tw-whitespace-nowrap">
                        <?php echo app('translator')->get('superadmin::lang.new_subscriptions'); ?>
                    </p>
                    <a href="<?php echo e(action([\Modules\Superadmin\Http\Controllers\SuperadminSubscriptionsController::class, 'index']), false); ?>"
                        class="small-box-footer"><?php echo app('translator')->get('superadmin::lang.more_info'); ?> <i class="fa fa-arrow-circle-right"></i></a>
         ...
         <a href="#" class="small-box-footer"><?php echo app('translator')->get('superadmin::lang.more_info'); ?><i class="fa fa-arrow-circle-right"></i></a>
            ...
            <div class="col-lg-4 col-xs-6">
                ...
                <?php $__env->startComponent('components.static', [
                    ...
                    <p class="tw-text-sm tw-font-medium tw-text-gray-500 tw-truncate tw-whitespace-nowrap">
                        <?php echo app('translator')->get('superadmin::lang.new_registrations'); ?>
                    </p>
                    <a href="<?php echo e(action([\Modules\Superadmin\Http\Controllers\BusinessController::class, 'index']), false); ?>"
                        class="small-box-footer"><?php echo app('translator')->get('superadmin::lang.more_info'); ?> <i class="fa fa-arrow-circle-right"></i></a>
                <?php echo $__env->renderComponent(); ?>
            ...
            <div class="col-lg-4 col-xs-6">
                <?php $__env->startComponent('components.static', [
                    ...
                    <p class="tw-text-sm tw-font-medium tw-text-gray-500 tw-truncate tw-whitespace-nowrap">
                        <?php echo app('translator')->get('superadmin::lang.not_subscribed'); ?>
                    </p>
                    <a href="<?php echo e(action([\Modules\Superadmin\Http\Controllers\BusinessController::class, 'index']), false); ?>"
                        class="small-box-footer"><?php echo app('translator')->get('superadmin::lang.more_info'); ?> <i class="fa fa-arrow-circle-right"></i></a>
                <?php echo $__env->renderComponent(); ?>
                    ...
                    <div class="tw-p-4 sm:tw-p-5">
                        <div class="tw-flex tw-items-center tw-gap-2.5">
                            ...
                            <h3
                                ...
                                <?php echo e(__('superadmin::lang.monthly_sales_trend'), false); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Hassa POS\Modules\Superadmin\Providers/../Resources/views/superadmin/index.blade.php ENDPATH**/ ?>