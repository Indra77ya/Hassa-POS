    ...
    <div class="row">
        ...
        <div class="col-xs-4">
            <div class="form-group">
                ...
                <input type="password" name="woocommerce_consumer_secret" value="<?php echo e($default_settings['woocommerce_consumer_secret'], false); ?>" id="woocommerce_consumer_secret" class="form-control">
            </div>
        </div>
        ...
        <div class="col-xs-4">
            <div class="checkbox">
                <label>
                    <br/>
                    <?php echo Form::checkbox('enable_auto_sync', 1, !empty($default_settings['enable_auto_sync']), ['class' => 'input-icheck'] ); ?> <?php echo app('translator')->get('woocommerce::lang.enable_auto_sync'); ?>
                </label>
                <?php
                if(session('business.enable_tooltip')){
                    echo '<i class="fa fa-info-circle text-info hover-q no-print " aria-hidden="true" 
...
</div><?php /**PATH C:\laragon\www\Hassa POS\Modules\Woocommerce\Providers/../Resources/views/woocommerce/partials/api_settings.blade.php ENDPATH**/ ?>