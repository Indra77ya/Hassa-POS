...
<aside class="side-bar tw-relative tw-hidden tw-h-screen tw-bg-white tw-w-64 xl:tw-w-64 lg:tw-flex lg:tw-flex-col tw-shrink-0 tw-border-r tw-border-gray-200">
    ...
    <a href="<?php echo e(route('home'), false); ?>"
        class="tw-relative tw-flex tw-items-center tw-justify-center tw-w-full tw-h-15 theme-logo-bg tw-shrink-0">
...
<?php /**PATH C:\laragon\www\Hassa POS\resources\views/layouts/partials/sidebar.blade.php ENDPATH**/ ?>