...
<fieldset>
<legend class="text-black"><?php echo app('translator')->get('business.business_details'); ?>:</legend>
<div class="col-md-12">
...
<?php if(empty($is_admin)): ?>
    ...
    <fieldset>
    <legend class="text-black"><?php echo app('translator')->get('business.business_settings'); ?>:</legend>
    <div class="col-md-6">
        <div class="form-group">
...
<fieldset>
<legend class="text-black"><?php echo app('translator')->get('business.owner_info'); ?></legend>
<div class="col-md-4">
    <div class="form-group">
...
<div class="col-md-6">
    <div class="form-group">
        ...
        <div class="input-group">
            ...
            <?php echo Form::text('email', null, ['class' => 'form-control','placeholder' => __('business.email'), 'required']); ?>
...
<div class="clearfix"></div>
    <?php if(!empty($system_settings['superadmin_enable_register_tc']) && !empty($is_register)): ?>
        <div class="col-md-6">
            <div>
                <label>
                    <?php echo Form::checkbox('accept_tc', 0, false, ['required', 'class' => 'input-check-box']); ?>
    ...
    <?php if(config('constants.enable_recaptcha') && !empty($is_register)): ?>
        <div class="col-md-6">
            <div class="form-group">
...
<?php if(config('constants.enable_recaptcha') && !empty($is_register)): ?>
    <script>
        window.RECAPTCHA_SITE_KEY = "<?php echo e(config('constants.google_recaptcha_key'), false); ?>";
    </script>
<?php endif; ?>
<?php /**PATH C:\laragon\www\Hassa POS\resources\views/business/partials/register_form.blade.php ENDPATH**/ ?>