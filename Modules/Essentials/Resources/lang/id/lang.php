...
return array (
  ...
  'my_payrolls' => 'Penggajian Saya',
  'view_all_payroll' => 'Lihat Semua Penggajian',
  'delete_payroll' => 'Hapus Penggajian',
  'access_sales_target' => 'Akses Target Penjualan',
  'sales_target' => 'Target Penjualan',
  'set_sales_target' => 'Tetapkan Target Penjualan',
  'set_sales_target_for' => 'Tetapkan Target Penjualan untuk :user',
  'total_sales_amount_from' => 'Total jumlah penjualan dari',
  'total_sales_amount_to' => 'Total jumlah penjualan hingga',
  'commission_percent' => 'Persentase Komisi',
  'sales_target_commission' => 'Komisi Target Penjualan',
  'calculate_sales_target_commission_without_tax' => 'Hitung Komisi Target Penjualan tanpa Pajak',
  'calculate_sales_target_commission_without_tax_help' => 'Jika dicentang, komisi target penjualan akan dihitung dari total penjualan oleh karyawan tanpa memperhitungkan pajak',
  'targets' => 'Target',
  'target_achieved_this_month' => 'Target tercapai bulan ini',
  'target_achieved_last_month' => 'Target tercapai bulan lalu',
  'my_sales_targets' => 'Target penjualan saya',
  'sales_targets' => 'Target penjualan',
  'get_current_location' => 'Dapatkan lokasi saat ini',
  'payroll_cant_be_deleted_if_final' => 'Penggajian tidak dapat dihapus jika statusnya sudah final',
  'add_todos' => 'Tambah Daftar Tugas',
  'edit_todos' => 'Edit Daftar Tugas',
  'delete_todos' => 'Hapus Daftar Tugas',
  'attendace_report_for' => 'Laporan Kehadiran untuk',
  'edit_enowledge_base' => 'Edit Basis Pengetahuan',
  'delete_enowledge_base' => 'Hapus Basis Pengetahuan',
);
