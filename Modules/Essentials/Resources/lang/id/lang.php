...
return [
    ...
    "set_sales_target" => "Atur Target Penjualan",
    "set_sales_target_for" => "Atur Target Penjualan untuk :user",
    ...
    "add_todos" => "Tambah Tugas (To Do)",
    "edit_todos" => "Edit Tugas (To Do)",
    "delete_todos" => "Hapus Tugas (To Do)",
