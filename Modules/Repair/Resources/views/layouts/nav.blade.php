<section class="no-print">
    <nav class="navbar-default tw-duration-5000 tw-shrink-0 tw-rounded-2xl tw-m-[16px] tw-border-2 !tw-bg-white">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{action([\Modules\Repair\Http\Controllers\DashboardController::class, 'index'])}}"><i class="fas fa-wrench"></i> {{__('repair::lang.repair')}}</a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    @can('repair.create')
                        <li @if(request()->segment(2) == 'repair' && request()->segment(3) == 'create') class="active" @endif><a href="{{ action([\App\Http\Controllers\SellPosController::class, 'create']). '?sub_type=repair'}}">@lang('repair::lang.add_invoice')</a></li>
                    @endcan
