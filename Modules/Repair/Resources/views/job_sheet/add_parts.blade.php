...
<section class="content-header">
    <h1 class="tw-text-xl md:tw-text-3xl tw-text-black" >@lang('repair::lang.add_jobsheet_parts')</h1>
</section>
...
<section class="content">
	...
	@endcomponent
	{!! Form::open(['url' => action([\Modules\Repair\Http\Controllers\JobSheetController::class, 'saveParts'], $job_sheet->id), 'method' => 'post', 'id' => 'add_part_form' ]) !!}
