                        ...
                        @if(!empty($job_sheet->customer->mobile))
                            @php
                                $whatsapp_text = __('repair::lang.whatsapp_message', [
                                    ...
                                    'estimated_cost' => $commonUtil->num_f($job_sheet->estimated_cost, true),
                    ...
                    <table class="table table-bordered" style="margin-top: 15px;">
                        ...
                        <tr>
                            ...
                            <td colspan="2">
                                ...
                                <strong>{{$jobsheet_settings['customer_label']}}:</strong><br>
                                @endif
                                <p>
                            ...
                            <td>
                                ...
                                {{$job_sheet->brand?->name}}
                                <br>
                                <b>@lang('repair::lang.device'):</b>
                                {{$job_sheet->device?->name}}
                                <br>
                                <b>@lang('repair::lang.device_model'):</b>
                                {{$job_sheet->deviceModel?->name}}
                                <br>
                        ...
                        <tr>
                            ...
                            <td>
                                {{$job_sheet->technician?->user_full_name}}
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">
