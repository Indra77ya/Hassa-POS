...
<section class="content-header">
    <h1 class="tw-text-xl md:tw-text-3xl tw-text-black">{{ __('assetmanagement::lang.add_asset') }}</h1>
</section>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    {!! Form::select('fixed_asset_account_id', $fixed_asset_accounts, null, ['class' => 'form-control select2', 'placeholder' => __('messages.please_select')]) !!}
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
