...
@section('content')
	...
	<section class="content-header no-print">
	   <h1 class="tw-text-xl md:tw-text-3xl tw-text-black">
	   		...
	   		<small class="tw-text-sm md:tw-text-base tw-text-gray-700 tw-font-semibold">@lang('crm::lang.send')</small>
	   </h1>
	</section>
	<!-- Main content -->
	<section class="content">
		@component('components.widget', ['class' => 'box-solid'])
			{!! Form::open(['url' => action([\Modules\Crm\Http\Controllers\ProposalController::class, 'store']), 'method' => 'post', 'id' => 'proposal_form']) !!}
				<div class="row">
					<div class="col-md-12">
