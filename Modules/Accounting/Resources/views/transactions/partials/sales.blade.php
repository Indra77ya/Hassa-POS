            ...
            <table class="table table-bordered table-striped" id="sell_table" style="width: 100%;">
                <thead>
                    <tr>
                        ...
                        <th style="white-space: nowrap !important;">@lang('lang_v1.payment_method')</th>
                        <th style="white-space: nowrap !important;">@lang('sale.total_amount')</th>
                        <th style="white-space: nowrap !important;">@lang('sale.total_paid')</th>
                        <th style="white-space: nowrap !important;">@lang('lang_v1.added_by')</th>
                        <th style="white-space: nowrap !important;">@lang('sale.sell_note')</th>
                        <th style="white-space: nowrap !important;">@lang('sale.staff_note')</th>
                    </tr>
                </thead>
                <tbody></tbody>
            </table>
