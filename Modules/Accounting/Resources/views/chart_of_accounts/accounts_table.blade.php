            ...
            <tr style="background-color: #f8fafc; font-weight: 600;">
                <td>
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu" style="left: 0 !important; right: auto !important; min-width: 130px !important;" role="menu">
                            <li>
                ...
                <td>
                    @if($account->status == 'active')
                        <span class="label label-success">@lang( 'accounting::lang.active' )</span>
                ...
                @foreach($account->child_accounts as $child_account)
                    <tr>
                        ...
                        <td style="padding-left: 28px;">
                            <span class="text-muted" style="margin-right: 5px;">↳</span>{{$child_account->name}}
                        </td>
