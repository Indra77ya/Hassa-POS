			...
			<div class="nav-tabs-custom">
				...
				<div class="tab-content">
					...
					<div class="tab-pane active" id="account_setting">
						...
						@if(!$account_exist)
							<div class="alert alert-danger" style="border-radius: 12px; padding: 20px; margin-top: 20px;">
								...
								<br>
								<a href="{{route('accounting.create-default-accounts')}}" class="btn btn-xs btn-primary" style="border: 1px solid currentColor;">
						...
						<div class="row">
							<div class="col-md-12 text-center">
								<div class="form-group">
									{{Form::submit(__('messages.update'), ['class' => "btn btn-primary btn-lg"])}}
								</div>
							</div>
						</div>
						@endif
					...
					<div class="tab-pane" id="sub_type_tab">
						<div class="row">
							<div class="col-md-12">
								<button class="btn pull-right btn-primary"id="add_account_sub_type" >
					...
					<div class="tab-pane" id="detail_type_tab">
						<div class="row">
							<div class="col-md-12">
								<button class="btn pull-right btn-primary"id="add_detail_type" >
									<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
										stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
										class="icon icon-tabler icons-tabler-outline icon-tabler-plus">
										<path stroke="none" d="M0 0h24v24H0z" fill="none" />
