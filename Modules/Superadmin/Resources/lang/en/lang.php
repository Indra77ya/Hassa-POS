...
return [
    ...
    "select_all_global" => "Total Reset / Select All Business Data",
    "select_all_global_help" => "Check to reset all business data at once (Transactions, Master Data, & Module Data). Business will be completely clean.",
    "select_all_transactions" => "Select All (Transaction Data)",
    "select_all_master" => "Select All (Master Data)",
    "select_all_modules" => "Select All (Module Data)",
    "reset_sales" => "Sales",
    ...
    "reset_units" => "Units",
    "reset_customer_groups" => "Customer Groups",
    "reset_warranties" => "Warranties",
    "reset_asset_management" => "Asset Management",
    "reset_manufacturing" => "Manufacturing",
    "reset_repair" => "Repair",
    "reset_essentials" => "HR & Essentials",
    "reset_crm" => "CRM",
    "reset_selected" => "Reset Selected Data",
    "reset_success" => "Data successfully reset!",
    "coupon_not_matched_with_packeg" => "Coupon does not match with package",
