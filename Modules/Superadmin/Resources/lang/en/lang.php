...
return [
    ...
    'applied_on_packages' => 'Applied on packages',
    'created_at' => 'Created at',
    'applied_on_packages_help_text' => 'If no packages selected it can be applied to all',
    'is_active' => 'Is active',
    'package_price_after_discount' => 'Package price after coupon discount',
    'coupon_is_deactive' => 'Coupon is deactive',
    'coupon_expired' => 'Coupon is expired',
    'you_save' => 'You save',
    'all_coupon' => 'All Coupons',
    'discount_amount_not_valid' => 'Discount amount not valid',
    'original_price' => 'Original price',
    'only_for_businesses' => 'Only for Businesses',
    'tooltip_only_for_businesses' => 'Select businesses to which this package will be shown. If empty then package will be shown to all businesses.',
    'paid_amount' => 'Paid Amount',
    'infinite_help' => '0 = infinite',
    'force_activate_now' => 'Force Activate Now',
    'upcoming' => 'Upcoming',
    ...
    'applied_on_business' => 'Applied on business',
    'applied_on_business_help_text' => 'If no business selected it can be applied to all',
    'invalid_coupon' => 'Invalid Coupon',
    'my_fatoorah' => 'Myfatoorah',
    'api_key_document' => 'API Key Document',
    'myfatoorah_account' => 'Myfatoorah account',
    'using_your_super_master_account' => 'using your Super Master Account.',
    ...
    'fatoorah_heahing' => 'You can get the live API token key as follows:',
    'fatoorah_step_2' => '2. Select the "Integration Settings" button from the left menu.',
    ...
    'reset_sales' => 'Delete Sales',
    'reset_purchases' => 'Delete Purchases',
    'reset_expenses' => 'Delete Expenses',
    'reset_registers' => 'Delete Cash Registers',
    'reset_stock_adjustments' => 'Delete Stock Adjustments & Transfers',
    'reset_products' => 'Delete Products',
    'reset_contacts' => 'Delete Contacts',
    'reset_categories' => 'Delete Categories & Brands',
    'reset_taxes' => 'Delete Custom Taxes',
    'reset_success' => 'Business data reset successfully!',
    'please_select_at_least_one' => 'Please select at least one data item to reset.',
    'reset_data_confirmation' => 'Are you sure you want to reset the selected data? This action cannot be undone.',
];
