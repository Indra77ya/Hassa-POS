<div class="col-md-4 tw-mb-5 {{ $package->interval }} tw-relative price_card">
    <div
        class="tw-flex tw-flex-col tw-gap-6 tw-p-6 tw-shadow bg-white tw-rounded-2xl tw-shadow-lg tw-duration-700 hover:tw-scale-110 tw-cursor-pointer">
