...
<section class="content-header">
    <h1 class="tw-text-xl md:tw-text-3xl tw-text-black">@lang('superadmin::lang.super_admin_settings')<small>@lang('superadmin::lang.edit_super_admin_settings')</small></h1>
    <!-- <ol class="breadcrumb">
...
<section class="content">
            ...
            {{-- <div class="col-xs-12 pos-tab-container"> --}}
                ...
                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 pos-tab-menu tw-rounded-lg">
                    <div class="list-group">
                        <a href="#" class="list-group-item text-center tw-text-sm md:tw-text-base active">@lang('superadmin::lang.super_admin_settings')</a>
                        <a href="#" class="list-group-item text-center tw-text-sm md:tw-text-base">@lang('superadmin::lang.application_settings')</a>
                        <a href="#" class="list-group-item text-center tw-text-sm md:tw-text-base">@lang('superadmin::lang.email_smtp_settings')</a>
                        <a href="#" class="list-group-item text-center tw-text-sm md:tw-text-base">@lang('superadmin::lang.payment_gateways')</a>
                        <a href="#" class="list-group-item text-center tw-text-sm md:tw-text-base">@lang('superadmin::lang.backup')</a>
                        <a href="#" class="list-group-item text-center tw-text-sm md:tw-text-base">@lang('superadmin::lang.cron')</a>
                        <a href="#" class="list-group-item text-center tw-text-sm md:tw-text-base">@lang('superadmin::lang.pusher_settings')</a>
                        <a href="#" class="list-group-item text-center tw-text-sm md:tw-text-base">@lang('superadmin::lang.additional_js_css')</a>
                    </div>
                </div>
    ...
    <div class="row">
        <div class="col-xs-12 text-center">
            ...
            {{Form::submit(__('messages.update'), ['class'=>"btn btn-danger btn-big"])}}
            </div>
        </div>
    </div>
    {!! Form::close() !!}
